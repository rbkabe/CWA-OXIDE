...
fn make_pet(guid: u32, name: &str, icon_id: u32, attachments: &[u32]) -> Pet {
    ...
    Pet {
        ...
        unknown10: false,
        unknown11: 0,
        unknown12: Unknown12 { unknown1: 0, unknown2: 0, unknown3: 0, unknown4: 0 },
        unknown13: Unknown13 {
    ...
    Player {
        data: PlayerData {
            ...
            pets: vec![
                ...
                make_pet(541,  "C-3PO",   74,   &[311, 430, 447]),
                make_pet(550,  "N0-80T",  77,   &[311, 430, 447]),
                make_pet(551,  "N-30H",   78,   &[311, 430, 447]),
                make_pet(552,  "J3-3V3",  76,   &[311, 430, 447]),
                make_pet(553,  "D-0T",    75,   &[311, 430, 447]),
                make_pet(998,  "RA-7",    1231, &[311, 430, 447]),
                // Mouse droids — group 168 parts: 424/444
                make_pet(542,  "F1-V3L",  71,   &[424, 444]),
                make_pet(2092, "1M-AU5",  1258, &[424, 444]),
                // Probe droid — group 171 parts: 657/658/659
                make_pet(543,  "PR-0B07", 73,   &[657, 658, 659]),
                // Power droid — group 173 parts: 428/429/436
                make_pet(544,  "5T-U85",  72,   &[428, 429, 436]),
                // Astromech droids — group 174 parts: 309/310/427
                make_pet(545,  "R2-D2",   64,   &[309, 310, 427]),
                make_pet(546,  "R3-S6",   66,   &[309, 310, 427]),
                make_pet(547,  "B3-3P5",  67,   &[309, 310, 427]),
                make_pet(548,  "M1-L0",   68,   &[309, 310, 427]),
                make_pet(549,  "B0-LT5",  69,   &[309, 310, 427]),
                make_pet(916,  "R2-KT",   1075, &[309, 310, 427]),
                make_pet(917,  "B3-T4",   1035, &[309, 310, 427]),
                make_pet(2146, "6R-0WL",  1464, &[309, 310, 427]),
                make_pet(2147, "P3-NUT",  1465, &[309, 310, 427]),
                make_pet(2393, "H3-4RT",  1675, &[309, 310, 427]),
                make_pet(2804, "7L-VN",   1998, &[309, 310, 427]),
                // AT-AT — group 169 parts: 563/564
                make_pet(632,  "5P-0T",   63,   &[563, 564]),
                // Techno-Service droid — group 172 parts: 560/561/562
                make_pet(633,  "T0-D0",   79,   &[560, 561, 562]),
                // Rabbit droid — no confirmed attachment group
                make_pet(554,  "BR-3R",   70,   &[]),
                // Unknown/unconfirmed droid types — no confirmed attachment group
                make_pet(2114, "J-4CK",   1385, &[]),
                make_pet(2115, "K-3RNL",  1384, &[]),
                make_pet(3080, "DU-3",    2392, &[]),
                make_pet(3081, "K0-5D",   2393, &[]),
                make_pet(3284, "BR-RR",   2574, &[]),
                // Creatures — Aedalus has gear (group 641: 2715/2716); others have none
                make_pet(2752, "Aedalus",  1846, &[2715, 2716]),
                make_pet(2786, "Gnarls",   1976, &[]),
                make_pet(2802, "Eeetch",   1997, &[]),
                make_pet(2899, "Vector",   2143, &[]),
                make_pet(3073, "Babbo",    2357, &[]),
                make_pet(3074, "Duppa",    2358, &[]),
                make_pet(3100, "Fang",     2587, &[]),
                make_pet(3219, "Erial",    2463, &[]),
                make_pet(3282, "Phileas",  2572, &[3274, 3275]),
                make_pet(3283, "Barnibus", 2573, &[3285]),
                make_pet(3366, "Marrok",   2667, &[]),
                make_pet(3373, "Ghorroh",  2700, &[]),
                // Missing companions (GUIDs assigned by emulator)
                make_pet(3420, "Skreech",                2800, &[]),
                make_pet(3421, "Cinch",                  2801, &[]),
                make_pet(3422, "Amelie",                 2802, &[]),
                make_pet(3423, "Gulsh",                  2803, &[]),
                make_pet(3424, "Kharroh",                2804, &[]),
                make_pet(3415, "Gash",                   2805, &[]),
                make_pet(3406, "Cercopes",               2806, &[]),
                make_pet(3407, "WAC-47",                 2807, &[]),
                make_pet(3408, "M5-BZ",                  2808, &[309, 310, 427]),
                make_pet(3425, "U9-C4",                  2809, &[309, 310, 427]),
                make_pet(3440, "BNI-393",                2810, &[]),
                make_pet(3446, "Security Battle Droid",  2811, &[]),
                make_pet(3447, "L1-LR3D",                2812, &[]),
                // Sidekicks — no attachment gear
                make_pet(3079, "Aktik", 1961, &[]),
                make_pet(3341, "Jynx",  1341, &[]),
                make_pet(3398, "Klug",  2131, &[]),
            ],
            pet_unknown1: -1,
            pet_unknown2: 0,
            mounts: owned_mounts,
